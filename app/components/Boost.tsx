...
export default function Boost() {
  return (
    <div className="px-[1rem] lg:px-[10rem] py-[6rem] bg-[url('/assets/images/bg-boost-desktop.svg')] h-[10rem] bg-[var(--dark-violet)] flex flex-col gap-[1rem] items-center justify-center">
